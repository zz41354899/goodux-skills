...
export const skills: Skill[] = [
  ...
  },
  {
    id: "ui-visual-design",
    name: "UI 視覺設計",
    description: "選擇與應用適合的 UI 視覺風格,提升介面設計品質與一致性。整合 101 種專業設計風格參考",
    category: "design",
    content: {
      overview: "UI 視覺設計專注於選擇與應用適合的視覺風格,包含色彩系統、字體排版、間距佈局與元件風格規範。整合 StylePrompts 設計風格庫,提供 101 種專業設計風格參考,幫助快速建立高品質的介面視覺。",
      whenToUse: [
        "需要選擇或定義產品視覺風格時",
        "建立色彩、字體、間距等視覺規範時",
        "提升介面設計專業度與美感時",
